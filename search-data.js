...
const searchData = [
    {
        ...
        precio: '$1.000 UYU',
        url: 'productos.html',
        imagen: 'img/pack-retro.jpg', // <-- NUEVO
        alt: 'Mega Pack Retro para PC con 7700 juegos' // <-- NUEVO
    },
    {
        tipo: 'Producto',
        ...
        precio: '$1.200 UYU',
        url: 'productos.html',
        imagen: 'img/pendrive-ps2.jpg', // <-- NUEVO
        alt: 'Pendrive PS2 para PC de 128GB con juegos a elección' // <-- NUEVO
    },
    {
        tipo: 'Servicio',
        ...
        precio: '$500',
        url: 'servicios.html',
        imagen: 'icon', // <-- Mantiene el ícono
        icon_class: 'fa-solid fa-gamepad' // <-- NUEVO
    },
    {
        tipo: 'Servicio',
